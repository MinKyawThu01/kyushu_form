                                ...
                                ?>
                                    ...
                                    <li>
                                        <label class="all_checks_radio">Male
                                            <input type="radio" name="gender" value="Male" <?php if ($_SESSION['old_gender'] == 'Male') {
                                                                                                echo 'checked';
                                                                                            } ?>>
                                    ...
                                    <li>
                                        <label class="all_checks_radio">Female
                                            <input type="radio" name="gender" value="Female" <?php if ($_SESSION['old_gender'] == 'Female') {
                                                                                                    echo 'checked';
                                                                                                } ?>>
                                            <span class="checkmark"></span>
                                        </label>
                                    ...
                                    <li>
                                        <label class="all_checks_radio">Other
                                            <input type="radio" name="gender" value="Other" <?php if ($_SESSION['old_gender'] == 'Other') {
                                                                                                echo 'checked';
                                                                                            } ?>>
                                            <span class="checkmark"></span>
                                        </label>
                                ...
                                ?>
                                    <li>
                                        <label class="all_checks_radio others-input">Singaporean
                                            <input type="radio" name="nationality" value="Singaporean" <?php if ($_SESSION['old_nati'] == 'Singaporean') {
                                                                                                            echo 'checked';
                                                                                                        } ?>>
                                            <span class="checkmark"></span>
                                        </label>
                                ...
                                ?>
                                    <li>
                                        <label class="all_checks_radio">Never
                                            <input type="radio" name="japan_before" id="never_input" class="c-form_radio" value="Never" <?php if ($_SESSION['old_before'] == 'Never') {
                                                                                                                                            echo 'checked';
                                                                                                                                        } ?>>
                                            <span class="checkmark"></span>
                                        </label>
                                    ...
                                    <li>
                                        <label class="all_checks_radio">Once
                                            <input type="radio" name="japan_before" class="c-form_radio" value="Once" <?php if ($_SESSION['old_before'] == 'Once') {
                                                                                                                            echo 'checked';
                                                                                                                        } ?>>
                                            <span class="checkmark"></span>
                                        </label>
                                    ...
                                    <li>
                                        <label class="all_checks_radio">Twice
                                            <input type="radio" name="japan_before" class="c-form_radio" value="Twice" <?php if ($_SESSION['old_before'] == 'Twice') {
                                                                                                                            echo 'checked';
                                                                                                                        } ?>>
                                            <span class="checkmark"></span>
                                        </label>
                                    ...
                                    <li>
                                        <label class="all_checks_radio">Thrice
                                            <input type="radio" name="japan_before" class="c-form_radio" value="Thrice" <?php if ($_SESSION['old_before'] == 'Thrice') {
                                                                                                                            echo 'checked';
                                                                                                                        } ?>>
                                            <span class="checkmark"></span>
                                        </label>
                                    ...
                                    <li>
                                        <label class="all_checks_radio">More than 3 times
                                            <input type="radio" name="japan_before" class="c-form_radio" value="More Than 3 Times" <?php if ($_SESSION['old_before'] == 'More Than 3 Times') {
                                                                                                                                        echo 'checked';
                                                                                                                                    } ?>>
                                            <span class="checkmark"></span>
                                        </label>
                        ...
                        <div class="form_gp">
                            ...
                            <ul>
                                ...
                                ?>
                                    ...
                                    <li>
                                        <label class="all_checks_radio">Male
                                            <input type="radio" name="gender_tc" value="Male" <?php if ($_SESSION['old_gender_tc'] == 'Male') {
                                                                                                    echo 'checked';
                                                                                                } ?>>
                                            <span class="checkmark"></span>
                                        </label>
                                    ...
                                    <li>
                                        <label class="all_checks_radio">Female
                                            <input type="radio" name="gender_tc" value="Female" <?php if ($_SESSION['old_gender_tc'] == 'Female') {
                                                                                                    echo 'checked';
                                                                                                } ?>>
                                            <span class="checkmark"></span>
                                        </label>
                                    ...
                                    <li>
                                        <label class="all_checks_radio">Other
                                            <input type="radio" name="gender_tc" value="Other" <?php if ($_SESSION['old_gender_tc'] == 'Other') {
                                                                                                    echo 'checked';
                                                                                                } ?>>
                                            <span class="checkmark"></span>
                                        </label>
                        ...
                        <div class="form_gp">
                            ...
                            <ul>
                                ...
                                ?>
                                    <li>
                                        <label class="all_checks_radio others-input">Singaporean
                                            <input type="radio" name="nationality_tc" value="Singaporean" <?php if ($_SESSION['old_nati_tc'] == 'Singaporean') {
                                                                                                                echo 'checked';
                                                                                                            } ?>>
                                            <span class="checkmark"></span>
                                        </label>
                                    ...
                                    ?>
                                        <li>
                                            <label class="all_checks_label">JNTO's Website (japan.travel)
                                                <input type="checkbox" name="campaign[]" value="JNTO's Website (japan.travel)" <?php if (in_array("JNTO's Website (japan.travel)", $_SESSION['old_camp'])) {
                                                                                                                                    echo 'checked';
                                                                                                                                } ?>>
                                                <span class="checkmark"></span>
                                            </label>
                                        ...
                                        <li>
                                            <label class="all_checks_label">JNTO's Facebook (Visit Japan Now)
                                                <input type="checkbox" name="campaign[]" value="JNTO's Facebook (Visit Japan Now)" <?php if (in_array("JNTO's Facebook (Visit Japan Now)", $_SESSION['old_camp'])) {
                                                                                                                                        echo 'checked';
                                                                                                                                    } ?>>
                                                <span class="checkmark"></span>
                                            </label>
                                        ...
                                        <li>
                                            <label class="all_checks_label">JNTO's Instagram (@visitjapansg)
                                                <input type="checkbox" name="campaign[]" value="JNTO's Instagram (@visitjapansg)" <?php if (in_array("JNTO's Instagram (@visitjapansg)", $_SESSION['old_camp'])) {
                                                                                                                                        echo 'checked';
                                                                                                                                    } ?>>
                                                <span class="checkmark"></span>
                                            </label>
                                        ...
                                        <li>
                                            <label class="all_checks_label">JAPAN by Japan EDM
                                                <input type="checkbox" name="campaign[]" value="JAPAN by Japan EDM" <?php if (in_array("JAPAN by Japan EDM", $_SESSION['old_camp'])) {
                                                                                                                        echo 'checked';
                                                                                                                    } ?>>
                                                <span class="checkmark"></span>
                                            </label>
                                        ...
                                        <li>
                                            <label class="all_checks_label">Japan Travel Fair
                                                <input type="checkbox" name="campaign[]" value="Japan Travel Fair" <?php if (in_array("Japan Travel Fair", $_SESSION['old_camp'])) {
                                                                                                                        echo 'checked';
                                                                                                                    } ?>>
                                                <span class="checkmark"></span>
                                            </label>
                                        ...
                                        <li>
                                            <label class="all_checks_label">Social media
                                                <input type="checkbox" name="campaign[]" value="Social media" <?php if (in_array("Social media", $_SESSION['old_camp'])) {
                                                                                                                    echo 'checked';
                                                                                                                } ?>>
                                                <span class="checkmark"></span>
                                            </label>
                                        ...
                                        <li>
                                            <label class="all_checks_label">Online news sites
                                                <input type="checkbox" name="campaign[]" value="Online news sites" <?php if (in_array("Online news sites", $_SESSION['old_camp'])) {
                                                                                                                        echo 'checked';
                                                                                                                    } ?>>
                                                <span class="checkmark"></span>
                                            </label>
